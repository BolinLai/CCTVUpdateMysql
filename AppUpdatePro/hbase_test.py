...
sql_str = "select tagid, count(*) from appdata.info2 where ymd=20171001 and flag=1 group by tagid order by tagid"
...
# sql_str = "select ymd, count(*) from appdata.info2 where flag=1 group by ymd order by ymd"
