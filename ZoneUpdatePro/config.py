...
class HbaseMysqlConfig:
    ...
    HBASE_TABLE = "areadata.areadata2"
...
class MysqlTable:
    ...
    Mysql
    """
    TAG = HbaseMysqlConfig.MYSQL_DB + ".tag_list"
    NODE = HbaseMysqlConfig.MYSQL_DB + ".node"
...
(
    PARTITION p201609 VALUES LESS THAN (2016100100)
);
